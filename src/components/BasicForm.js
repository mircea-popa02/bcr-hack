      ...
      <div className="inputs-and-button">
        <div className="control-group">
          ...
          <div className={dateClasses}>
            ...
            />
            {dateHasError && <p className="error-text">Te rog introdu o dată.</p>}
          </div>
          ...
          <div className={phoneClasses}>
            ...
            />
            {phoneHasError && (
              <p className="error-text">Te rog introdu un număr de telefon.</p>
            )}
          </div>
          <div className={emailClasses}>
            <label htmlFor="ownersEmail">E-mail</label>
            <input
              type="text"
              id="ownersEmail"
              value={emailValue}
            ...
            />
            {emailHasError && (
              <p className="error-text">Te rog introdu o adresă de e-mail.</p>
            )}
          </div>
        </div>
